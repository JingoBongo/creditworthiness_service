...
@app.route('/schedulers/statuses', methods=['GET'])
def get_shedulers_list(request):
    """list schedulers, simple GET request
    """
    return str(db.select_from_table('schedulers'))


@app.route('/services/statuses', methods=['GET'])
def get_services_list(request):
    """list services, simple GET request
    """
...
def get_rid_of_service(pid):
    """remove service by given PID
    CAUTION: kills any process by PID, even if it's not Fuse one
    Args:
...
def get_rid_of_service_post(request):
    # Accepts JSON!
...
def start_service_post(request):
    """Starts a service. provide with service name from config..
            ---
        responses:
          200:
...
def config_get_disabled_services(request):
    """Starts a service. provide with service name from config..
            ---
        responses:
          200:
...
def config_get_disabled_services_dict(request):
    """Starts a service. provide with service name from config..
            ---
        responses:
          200:
