...
# conf_path = os.path.normpath('.//resources//fuse_sanic.yaml')
secret_path = root_path + os.path.normpath('.//resources//secret.bin')
...
local_modules_table_name = 'Local_Modules'
remote_modules_table_name = 'Remote_Modules'
