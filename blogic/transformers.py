...
#         xmin = x_min - offset
#         ymin = y_min - offset
#         xmax = xmin + width + offset * 2
#         ymax = ymin + height + offset * 2
#
#         #   make sure that offset has not moved boundaries out of image bounds
#         if xmin < 0:
#             xmin = 0
#         if ymin < 0:
#             ymin = 0
...
#                                                    0].location_data.relative_bounding_box.height,
#                                                image_cols,
#                                                image_rows,
#                                                self.offset
#                                                )
